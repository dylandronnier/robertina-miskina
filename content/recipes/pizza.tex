\recette{Calzone supplément levure}
\auteurrecette{Hélène et Michel}

\preptime{45 min} \baketime{180\textdegree C, 20 min} \people{6} \robot{Pétrir}
...
\info{\textbf{Astuce} : Utiliser une spatule en bois pour placer la pizza dans le four à pizza.}
